                    ...
                    <div class="flex flex-col w-55 space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <select id="quantity" name="quantity"
                                ...
                                <option value="1kg" {{ $product->quantity == '1kg' ? 'selected' : '' }}>1kg</option>
                                <option value="100g" {{ $product->quantity == '100g' ? 'selected' : '' }}>100g</option>
                                <option value="1piece" {{ $product->quantity == '1piece' ? 'selected' : '' }}>1piece</option>
                            </select>
                    ...
                    <div class="flex flex-col w-55 space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <select id="tag" name="tag"
                                ...
                                <option value="Fruits" {{ $product->tag == 'Fruits' ? 'selected' : '' }}>Fruits</option>
                                <option value="Vegetables" {{ $product->tag == 'Vegetables' ? 'selected' : '' }}>Vegetables</option>
                                <option value="Poultry and meat" {{ $product->tag == 'Poultry and meat' ? 'selected' : '' }}>Poultry and meat</option>
                                <option value="Fish" {{ $product->tag == 'Fish' ? 'selected' : '' }}>Fish</option>
                                <option value="Bakery" {{ $product->tag == 'Bakery' ? 'selected' : '' }}>Bakery</option>
                                <option value="Others" {{ $product->tag == 'Others' ? 'selected' : '' }}>Others</option>
                            </select>
